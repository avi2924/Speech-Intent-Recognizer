...
def evaluate(args, config):
    ...
    # IMPORTANT: Use 31 classes to match the saved model
    model = CNNAudioGRU(num_classes=31).to(device)  # This matches your saved model
    ...
    test_loader = DataLoader(
        ...
        pin_memory=True  # Add this to speed up CPU->GPU transfers
    )
